...
*/
	protected function fold($string = "", $length = 75)
	{
		$folded_string = "";
...
* @return Escaped string
*/
	protected function &explodeVar($variable, $separator = ",") 
	{
	...
	/**
	* Returns the vCard representation of the object
	*
...
*/
	protected function quoted_printable_encode($input, $line_max = 76) 
	{
